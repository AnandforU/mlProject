...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info(f"Directory to be created: {os.path.dirname(self.ingestion_config.train_data_path)}")
            ...
            # print(f"Directory to be created: {os.path.dirname(self.ingestion_config.train_data_path)}")
